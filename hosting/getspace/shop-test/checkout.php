    ...
    <section class="checkout-shell checkout-page" aria-label="Zamówienie">
      ...
      <form method="post" action="/sklep/order" class="checkout-form" data-checkout-form>
        ...
        <section class="checkout-step">
          ...
          <label>E-mail<input name="customer_email" value="<?= checkout_value($checkoutOld, 'customer_email') ?>" type="email" required autocomplete="email"<?= checkout_field_attrs($checkoutErrors, 'customer_email') ?>><?= checkout_error($checkoutErrors, 'customer_email') ?></label>
          <label>Telefon<input name="customer_phone" value="<?= checkout_value($checkoutOld, 'customer_phone') ?>" required autocomplete="tel"<?= checkout_field_attrs($checkoutErrors, 'customer_phone') ?>><?= checkout_error($checkoutErrors, 'customer_phone') ?></label>
        </section>
        <section class="checkout-step">
          ...
          <div class="form-row"><label>Kod pocztowy<input name="delivery_postal_code" value="<?= checkout_value($checkoutOld, 'delivery_postal_code') ?>" required autocomplete="postal-code"<?= checkout_field_attrs($checkoutErrors, 'delivery_postal_code') ?>><?= checkout_error($checkoutErrors, 'delivery_postal_code') ?></label><label>Miejscowość<input name="delivery_city" value="<?= checkout_value($checkoutOld, 'delivery_city') ?>" required autocomplete="address-level2"<?= checkout_field_attrs($checkoutErrors, 'delivery_city') ?>><?= checkout_error($checkoutErrors, 'delivery_city') ?></label></div>
